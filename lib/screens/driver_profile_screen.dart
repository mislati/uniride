      ...
      body: user == null
          ...
          : StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                String bikeBrand = userData['bikeBrand'] ?? 'Standard Bike (Tap to Edit)';
                String displayName = rawName.isEmpty ? matric : rawName;
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: const CircleAvatar(
                          radius: 50,
                          backgroundColor: Colors.white,
                          child: Icon(Icons.drive_eta, size: 50, color: Color(0xFF5A5BFF)),
                        ),
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () => _updateProfileField('fullName', rawName, 'Official Name'),
                          ),
                        ],
                      ),
                      Container(
                      ...
                      const SizedBox(height: 16),
                      _buildProfileItem(Icons.motorcycle, 'Bike Brand', bikeBrand, isEditable: true, onEdit: () => _updateProfileField('bikeBrand', bikeBrand, 'Bike Brand')),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.white,
                            side: const BorderSide(color: Color(0xFF5A5BFF)),
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15)),
                          ),
                          icon: const Icon(Icons.support_agent, color: Color(0xFF5A5BFF)),
                          label: const Text('Contact Us', style: TextStyle(fontSize: 18, color: Color(0xFF5A5BFF), fontWeight: FontWeight.bold)),
                        ),
                      ),
