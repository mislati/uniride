          ...
          : StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return const Center(
                    child: Text("You haven't taken any rides yet.", style: TextStyle(color: Colors.grey, fontSize: 16))
                  );
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    // FIX: Extract the dynamic exact price saved in the database
                    ...
                    return Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          // FIX: Display the real dynamic price here
                          Text('₦$exactPrice', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                        ],
                      ),
                    );
                  },
